 ...
 * jsinterop.base.Js#asAny} and {@link jsinterop.base.Js#asPropertyMap} pass the value this
 * returns, so the same code reaches the DOM node on TeaVM instead of its wrapper.
 */
