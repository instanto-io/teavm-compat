...
public class BidiUtils {
  ...
  /**
   * The value for the directionality property which will set the element directionality to
   * right-to-left.
   */
   ...
   * @return <code>RTL</code> if the directionality is right-to-left, <code>LTR</code> if the
   *     directionality is left-to-right, or <code>DEFAULT</code> if the directionality is not
   *     explicitly set
   */
   ...
   * @param direction <code>RTL</code> if the directionality should be set to right-to-left, <code>
   *     LTR</code> if the directionality should be set to left-to-right <code>DEFAULT</code> if the
   *     directionality should be removed from the element
   */
