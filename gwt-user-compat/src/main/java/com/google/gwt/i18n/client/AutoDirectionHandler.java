 ...
 *
 * <p>This class is useful for automatically adjusting the direction of an object that takes text
 * input, while the text is being entered.
 */
public class AutoDirectionHandler implements KeyUpHandler, HasDirectionEstimator {
   ...
   *
   * <p>TODO(tomerigo): add Paste and Input events once they're available in GWT.
   */
  ...
  /**
   * Operates like {@link #addTo(Target, DirectionEstimator)}, but always uses a default
   * DirectionEstimator, {@link com.google.gwt.i18n.shared.WordCountDirectionEstimator}.
   *
   * @param target Object whose direction should be automatically adjusted on relevant events.
   * @return AutoDirectionHandler An instance of AutoDirectionHandler for the given object.
   */
  ...
  /**
   * Operates like {@link #addTo(Target, DirectionEstimator)}, but uses a default
   * DirectionEstimator, {@link com.google.gwt.i18n.shared.WordCountDirectionEstimator} if {@code
   * enabled}, or else a null DirectionEstimator, which means disabling direction estimation.
   *
   * @param target Object whose direction should be automatically adjusted on relevant events.
   ...
   * Initializes it with the given DirectionEstimator. - Adds it as an event handler for the
   * relevant events on the given object. - Returns the AutoDirectionHandler, so its setAutoDir()
   * method can be called when the object's text changes by means other than the handled events.
   *
   * @param target Object whose direction should be automatically adjusted on relevant events.
   * @param directionEstimator A DirectionEstimator object used for direction estimation (use null
   *     to disable direction estimation).
   * @return AutoDirectionHandler An instance of AutoDirectionHandler for the given object.
   */
   ...
   *
   * @param target Object whose direction should be automatically adjusted on relevant events.
   * @param directionEstimator A DirectionEstimator object used for direction estimation.
   */
  ...
  /**
   * Automatically adjusts hasDirection's direction on KeyUpEvent events. Implementation of
   * KeyUpHandler interface method.
   */
