 ...
 *
 * <p>This annotation marks methods in which an expression without a {@link
 * com.google.gwt.safehtml.shared.annotations.IsSafeHtml} annotation is used in a context where such
 * an annotation is required (e.g., the return statement of a method that returns {@code @IsSafeHtml
 * String}).
 *
