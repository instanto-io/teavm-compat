 ...
 * the Cross-Site-Scripting-safe HTML markup encapsulated in a {@link
 * com.google.gwt.safehtml.shared.SafeHtml} object.
 */
public interface HasSafeHtml {
   ...
   *
   * <p>The object will behave exactly the same as when a widget's {@link
   ...
   * without causing unsafe script execution. Thus, unlike {@link
