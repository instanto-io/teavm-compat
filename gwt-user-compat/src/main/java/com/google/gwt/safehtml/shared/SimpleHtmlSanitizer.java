 ...
 * </ul>
 *
 * as well as numeric HTML entities and HTML entity references. Any HTML metacharacters that do not
 * appear as part of markup in this subset will be HTML-escaped.
 */
