...
public class DirectionalTextHelper implements HasDirectionEstimator {
   ...
   * element itself. See {@link #setText(String, com.google.gwt.i18n.client.HasDirection.Direction,
   * boolean) setText(String, Direction, boolean)} for details.
   */
  ...
  /** See note at {@link #setDirectionEstimator(com.google.gwt.i18n.shared.DirectionEstimator)}. */
   ...
   * affected as described at {@link #setText(String,
   * com.google.gwt.i18n.client.HasDirection.Direction) setText(String, Direction)}.
   *
   ...
   * direction is verified to match the element's initial direction. Otherwise, the direction is
   * affected as described at {@link #setHtml(String,
   * com.google.gwt.i18n.client.HasDirection.Direction) setHtml(String, Direction)}.
   *
   * @param content the element's new content
   */
   ...
   *       direction of its context. See {@link com.google.gwt.i18n.shared.BidiFormatter} for more
   *       details.
   * </ul>
   *
   * @param content the element's new content
   ...
   * direction. Prefer using {@link #setText(String,
   * com.google.gwt.i18n.client.HasDirection.Direction) setText} or {@link #setHtml(String,
   * com.google.gwt.i18n.client.HasDirection.Direction) setHtml} instead of this method.
   *
   * @param content the element's new content
   * @param dir the content's direction
   * @param isHtml whether the content is HTML
