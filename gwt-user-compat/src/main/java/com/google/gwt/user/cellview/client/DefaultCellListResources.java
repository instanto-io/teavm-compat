...
/**
 * Default {@link CellList.Resources}: empty style names and no images, so the widget carries no GWT
 * styling of its own.
 */
public class DefaultCellListResources implements CellList.Resources {

  private final CellList.Style style = new EmptyStyle();
  ...
  private static final class EmptyStyle implements CellList.Style {
