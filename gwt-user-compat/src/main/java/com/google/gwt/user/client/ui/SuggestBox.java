...
public class SuggestBox extends Composite
    implements HasValue<String>,
        HasEnabled,
        com.google.gwt.event.logical.shared.HasSelectionHandlers<SuggestOracle.Suggestion> {
  ...
  public void showSuggestionList() {
    if (isAttached()) refreshSuggestions();
  }
  ...
  public HandlerRegistration addSelectionHandler(
      com.google.gwt.event.logical.shared.SelectionHandler<SuggestOracle.Suggestion> handler) {
    return addHandler(handler, com.google.gwt.event.logical.shared.SelectionEvent.getType());
  }
  ...
  public void applySuggestion(final SuggestOracle.Suggestion suggestion) {
    ...
    com.google.gwt.event.logical.shared.SelectionEvent.fire(this, suggestion);
  }
