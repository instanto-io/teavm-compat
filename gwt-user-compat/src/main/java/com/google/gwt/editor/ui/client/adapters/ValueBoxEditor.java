...
/**
 * Adapts the {@link ValueBoxBase} interface to the Editor framework. This adapter uses {@link
 * ValueBoxBase#getValueOrThrow()} to report parse errors to the Editor framework.
 *
