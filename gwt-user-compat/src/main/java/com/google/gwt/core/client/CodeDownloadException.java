...
public final class CodeDownloadException extends RuntimeException {
  ...
  /**
   * Reason codes for the interruption of code down load. These can be due to missing resource or
   * server not responding or user switching to a new page indicating resource doesn't need to be
   * down loaded.
   */
  public enum Reason {
