 ...
 */
public interface ArrayBufferView extends org.teavm.jso.JSObject {
   ...
   */
  @org.teavm.jso.JSProperty("buffer")
  ArrayBuffer buffer();
   ...
   */
  @org.teavm.jso.JSProperty("byteLength")
  int byteLength();
   ...
   */
  @org.teavm.jso.JSProperty("byteOffset")
  int byteOffset();
}
