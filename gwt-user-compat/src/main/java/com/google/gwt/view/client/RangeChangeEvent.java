...
/** Fired when the visible range of a view changes. */
public class RangeChangeEvent extends GwtEvent<RangeChangeEvent.Handler> {
  ...
  protected RangeChangeEvent(final Range range) {
    this.range = range;
  }
  ...
  public static void fire(final HasRows source, final Range range) {
