...
/** Fired when a selection model's selection changes. */
public class SelectionChangeEvent extends GwtEvent<SelectionChangeEvent.Handler> {
  ...
  /** A source of selection changes. */
  public interface HasSelectionChangedHandlers extends HasHandlers {
    com.google.gwt.event.shared.HandlerRegistration addSelectionChangeHandler(Handler handler);
  }
  ...
  public static void fire(final HasSelectionChangedHandlers source) {
    source.fireEvent(new SelectionChangeEvent());
  }
