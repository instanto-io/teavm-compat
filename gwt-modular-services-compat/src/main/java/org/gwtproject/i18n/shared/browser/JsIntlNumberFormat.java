...
/** TeaVM binding for the browser's {@code Intl.NumberFormat} API. */
@JSClass(name = "globalThis.Intl.NumberFormat")
public class JsIntlNumberFormat implements JSObject {
