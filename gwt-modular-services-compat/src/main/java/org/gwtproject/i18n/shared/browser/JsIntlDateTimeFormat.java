...
/**
 * TeaVM binding for the browser's {@code Intl.DateTimeFormat} API.
 *
 ...
 */
@JSClass(name = "globalThis.Intl.DateTimeFormat")
public class JsIntlDateTimeFormat implements JSObject {
